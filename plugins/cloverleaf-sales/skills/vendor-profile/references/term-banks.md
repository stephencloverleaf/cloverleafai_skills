...
a category here, apply the method from SKILL.md (incident phrasing + project phrasing +
budget-line phrasing) and write your own.
...
- **Fit:** all; CISO, IT Director, internal audit

## 10. DevSecOps / software delivery (e.g. GitLab)
- **Pain terms:** `software development`, `application modernization`, `legacy system`, `IT modernization`, `custom software`, `developer`, `agile`, `cloud migration`, `digital services`, `software supply chain`, `application security`
- **Competitors/incumbents:** GitHub/Microsoft, Atlassian (Jira/Bitbucket), Azure DevOps, AWS (CodeCatalyst), Jenkins
- **Funding hooks:** `IT modernization`, `capital improvement`, `ARPA`, `digital transformation`, `technology bond`
- **Fit:** larger cities/counties, states, higher-ed, agencies with in-house dev; CIO, IT Director, Digital Services Director
- **Note:** lean toward entities big enough to *build*, not just buy. Small towns rarely have developers.

## 11. AI / automation / productivity (e.g. Anthropic public sector)
- **Pain terms:** `artificial intelligence`, `automation`, `efficiency`, `staff shortage`, `backlog`, `call center`, `constituent services`, `permitting backlog`, `records request`, `public records`, `translation`, `document review`, `workforce`
- **Competitors/incumbents:** Microsoft Copilot, Google (Gemini/Vertex), OpenAI/ChatGPT Gov, Palantir, ServiceNow AI
- **Funding hooks:** `IT modernization`, `ARPA`, `efficiency`, `digital transformation`, `innovation fund`
- **Fit:** states, large cities/counties, agencies with service backlogs; CIO, Chief Innovation/Data Officer, City Manager
- **Note:** the buying signal is usually a *workload pain* (backlog, staffing) or an *AI-policy/governance* discussion, not the word "AI" alone. Search both.

## 12. Networking / connectivity / broadband
- **Pain terms:** `broadband`, `connectivity`, `fiber`, `digital divide`, `network infrastructure`, `Wi-Fi`, `E-Rate`, `rural connectivity`
- **Competitors/incumbents:** Cisco/Meraki, Aruba, Juniper/Mist, local ISPs/integrators
- **Funding hooks:** `E-Rate`, `BEAD`, `broadband grant`, `ARPA`, `capital improvement`, `FCC Rural Health Care`
- **Fit:** K-12/libraries (E-Rate), rural counties, tribal governments; IT/Tech Director, Public Works, City Manager

## 13. ERP / financial systems / permitting
- **Pain terms:** `ERP`, `financial system`, `legacy system`, `permitting`, `payroll`, `accounting system replacement`, `enterprise software`, `system upgrade`
- **Competitors/incumbents:** Tyler Technologies, Workday, Oracle, SAP, OpenGov, Accela
- **Funding hooks:** `capital improvement`, `IT modernization`, `bond`, `ARPA`
- **Fit:** cities, counties, school districts; Finance Director, CIO, City Manager

## 14. GIS / data / asset management
- **Pain terms:** `GIS`, `asset management`, `infrastructure inventory`, `mapping`, `data management`, `work order`, `public works software`
- **Competitors/incumbents:** Esri, Cityworks/Trimble, Cartegraph, Bentley
- **Funding hooks:** `capital improvement`, `infrastructure grant`, `utility rate study`
- **Fit:** public works, utilities, planning; Public Works Director, GIS Manager, Utility Director
...
- **Connectivity:** `E-Rate`, `BEAD`, `broadband grant`, `FCC Rural Health Care`
- **General capital/tech:** `IT budget`, `IT modernization`, `capital improvement`, `CIP`, `bond`, `technology bond`, `ARPA`, `innovation fund`, `digital transformation`
- **Tribal (Stephen's specialty):** `SLCGP`, `THSGP` (Tribal Homeland Security Grant Program), `TCGP` (Tribal Cybersecurity Grant Program), `tribal grant`
- **Process/timing words that mean a decision is near:** `RFP`, `RFQ`, `budget workshop`, `fiscal year`, `procurement`, `request for proposal`, `award`
...
- **Modernization / delivery:** `IT modernization`, `legacy modernization`, `technical debt`, `software factory`, `DevSecOps`, `continuous ATO`, `cATO`, `cloud migration`, `digital service`, `shared service`
- **Security framing:** `zero trust`, `software supply chain`, `SBOM`, `cybersecurity posture`, `FISMA`, `FedRAMP`, `authority to operate`, `continuous monitoring`
- **AI / automation:** `artificial intelligence`, `generative AI`, `automation`, `AI governance`, `responsible AI`, `workforce`, `backlog`
- **Oversight / pressure language (signals an agency under heat):** `GAO report`, `inspector general`, `audit finding`, `system failure`, `outage`, `breach`, `material weakness`, `high-risk list`
